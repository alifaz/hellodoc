...
<?php
	...
	$query2     = mysqli_query($conn, "SELECT * FROM user WHERE report>3");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <center><h1 class="page-header">User Report List</h1></center>
                    </div>
                  ...
                  <?php
                  	$count = 1;
										$query1 = mysqli_query($conn, "SELECT * FROM user WHERE report>3");
						...
						while($row = mysqli_fetch_assoc($query1)){
							echo
								'<tr>
									...
									<td>'.$row["user_name"].'</td>
									<td>'.$row["name_user"].'</td>
									<form action="../access/delete-user-admin.php" method="post">
										<td><button value="'.$row["user_name"].'" name="username" type="submit" class="btn btn-danger">Delete</button></td>
									</form>
								</tr>';
						}
					}
