...
<head>
    ...
    <title>Hello, Doc! || Patient List</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <center><h1 class="page-header">Patient List</h1></center>
                    </div>
                  ...
                  $query1 = mysqli_query($conn, "SELECT * FROM user WHERE Authority <> '1'
                    AND Authority <> '2' AND Authority <> '3'");
						...
						while($row = mysqli_fetch_assoc($query1)){
							echo
								'<tr>
									...
									<form action="../access/deleteproccesspatient.php" method="post">
