...
<?php
	...
	$query2     = mysqli_query($conn, "SELECT * FROM thread WHERE report>3");
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                  	$count = 1;
										$query1 = mysqli_query($conn, "SELECT * FROM thread WHERE report>3");
						...
						while($row = mysqli_fetch_assoc($query1)){
							echo
								'<tr>
									...
									<td>'.$row["judul"].'</td>
									<td>'.$row["nameuser"].'</td>
									<form action="thread-read-admin.php" method="post">
										<td><button value="'.$row["id_thread"].'" name="id_thread" type="submit" class="btn btn-danger">Lihat</button></td>
									</form>
								</tr>';
						}
					}
