...
<head>
    ...
    <title>Hello, Doc! || Admin List</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <center><h1 class="page-header">Admin List</h1></center>
                    </div>
                  ...
                  $query1 = mysqli_query($conn, "SELECT * FROM rsadmin");
				...
				//	echo $query['rsid_admin'];
						...
						while($row = mysqli_fetch_assoc($query1)){
							echo
								'<tr>
									...
									<td>'.$row["rsname"].'</td>
                  <form action="adminrsedit.php" method="post">
										<td><button value="'.$row["rsid_admin"].'" name="edit" type="submit" class="btn btn-primary">Edit</button></td>
									</form>
									<form action="../access/deleteproccessadmin.php" method="post">
										<td><button value="'.$row["rsid_admin"].'" name="delete" type="submit" class="btn btn-danger">Delete</button></td>
									</form>
								</tr>';
						}
					}
                  ...
                  ?>
                        ...
                        <a href="adminregistration.php?id='.$query['rsid_admin'].'"><button type="button" class="btn btn-primary">
													<span class="glyphicon glyphicon-pencil"></span>  Register An Admin RS, Now!</button></a>
                    </div>
