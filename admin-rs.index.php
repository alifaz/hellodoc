...
<html lang="en">
  <head>
    ...
    <title>Hello, Doc! || Admin RS</title>
  ...
  <body>
                ...
                <form name = "create" action = "access/semilogin.php" method = "post">
		              <div class="modal-dialog">
		                  <div class="modal-content">
                              ...
                              <br>
                              <input type="password" name="specialcode" placeholder="Special Code" autocomplete="off" class="form-control placeholder-no-fix">
		                      </div>
    ...
    <script>
        $.backstretch("img/Login.doctor7.jpg", {speed: 5000});
