...
<?php
	...
	require_once "header-user.php";
	  ...
	  $password_cek  = $_SESSION['password'];
		...
		$updatebaca = mysqli_query($conn, "UPDATE konsultasi SET baca_pasien=0 WHERE id_konsultasi='$id_konsultasi'");

		$query2 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_konsultasi='$id_konsultasi'");
		$query3 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_konsultasi='$id_konsultasi'");
 ?>
                ...
                <div class="col-md-12">
									<div class="content-panel">
										<table class="table table-responsive table-striped table-advance table-hover">
											...
											<form class="form-horizontal style-form" action="consultation.php" method="post">
