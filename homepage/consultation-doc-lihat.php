...
include "../connect.php";
	...
	require_once "header-doc.php";
	  ...
	  $password_cek  = $_SESSION['password'];
		...
		$updatebaca = mysqli_query($conn, "UPDATE konsultasi SET baca=0 WHERE id_konsultasi='$id_konsultasi'");

		$query1 = mysqli_query($conn, "SELECT * FROM doctor WHERE username = '$id'");
		$result1 = mysqli_fetch_array($query1);
		$id_doc = $result1['id_doctor'];
		$query2 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_doctor = '$id_doc' and id_konsultasi='$id_konsultasi'");
		$query3 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_doctor = '$id_doc' and id_konsultasi='$id_konsultasi'");
 ?>
          ...
          <section class="wrapper">
            <div class="row mt">
                <div class="col-md-12">
									...
									<form class="form-horizontal style-form" action="consultation-doc.php" method="post">
										<div class="form-group centered">
										<button name="id_konsultasi" type="submit" class="btn btn-info btn-md">Lihat Semua Konsultasi</button>
										</div>
									</form>
											</div>
                    </div><!-- /content-panel -->
