                    ...
                    <div class="content-panel">
                        <table class="table table-responsive table-striped table-advance table-hover">
                          <h2 class="centered">Daftar Konsultasi</h2>
                            ...
                            <tbody>
                            <tr>
                                <td><a href="profil-pasien.php"><h5>Opan</h5></a></td>
                                <td><h5>Diare udah 3 hari<h5></td>
                                <td><h4><span class="label label-warning">Belum dikonfirmasi</h4></span></td>
                                <td>
																		<a href="terimaproses.php" class="btn btn-success btn-md" role="button"><i class="fa fa-check "></i> Terima</a>
																		<a href="tolakproses.php" class="btn btn-danger btn-md" role="button"><i class="fa fa-ban "></i> Tolak</a>
                                </td>
                            </tr>
														<tr>
                                <td><a href="profil-pasien.php"><h5>Muhammad</h5></a></td>
                                <td><h5>Batuk udah 3 hari<h5></td>
                                <td><h4><span class="label label-success">Sudah diterima</h4></span></td>
                                <td>
																	<a href="chat-doc.php" class="btn btn-primary btn-md" role="button"><i class="fa fa-comments-o "></i> Hubungi</a>
																	<a href="hapusproses.php" class="btn btn-warning btn-md" role="button"><i class="fa fa-trash-o "></i> Hapus</a>
																</td>
                            </tr>
														<tr>
                                <td><a href="profil-pasien.php"><h5>Meilinda</h5></a></td>
                                <td><h5>Vertigo udah 3 hari<h5></td>
                                <td><h4><span class="label label-danger">Ditolak</h4></span></td>
                                <td><a href="hapusproses.php" class="btn btn-warning btn-md" role="button"><i class="fa fa-trash-o "></i> Hapus</a>
																</td>
                            </tr>
                            </tbody>
