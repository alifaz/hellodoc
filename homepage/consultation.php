...
<?php
	  ...
	  $_SESSION['name'] = $result['name_user'];
		...
		$query2 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_user = '$id' ORDER BY id_konsultasi DESC");
		$query3 = mysqli_query($conn, "SELECT * FROM konsultasi WHERE id_user = '$id' ORDER BY id_konsultasi DESC");
