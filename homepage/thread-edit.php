...
$result2 = mysqli_fetch_array($query_thread);
?>
					...
					<div class="form-panel">
						...
						<form class="form-horizontal style-form" action="../access/thread-editprocess.php" method="post">
							<div class="form-group">
								<div class="col-sm-10">
									<textarea style="height:40px" type="text" class="form-control" maxlength="90" placeholder="Judul thread (maksimal 90 karakter)" name="judul"><?php echo $result2['judul']?></textarea>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-10">
									<textarea style="height:300px" type="text" class="form-control" placeholder="Isi thread" name="isi"><?php echo $result2['isi']?></textarea>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-10">
